...
export interface SuAccessControlSingletonInterface extends utils.Interface {
  functions: {
...
export interface SuAccessControlSingleton extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuAccessControlSingletonInterface;
