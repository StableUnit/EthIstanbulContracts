...
export interface SuAuthenticatedInterface extends utils.Interface {
  functions: {
...
export interface SuAuthenticated extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuAuthenticatedInterface;
